...
export const BentoGrid = () => {
  return <div className="w-full max-w-[800px] grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <Card disabled={true} className="bg-[#CCCCCC] h-[240px] sm:h-[270px] md:h-[300px] flex items-center justify-center opacity-50">
        <h2 className="text-xl sm:text-2xl font-semibold text-gray-600 font-['Inter']">
          Скоро появится
        </h2>
      </Card>
      <Card disabled={true} className="md:col-span-2 bg-[#CCCCCC] h-[240px] sm:h-[270px] md:h-[300px] flex items-center justify-center opacity-50">
        <h2 className="text-xl sm:text-2xl font-semibold text-gray-600 font-['Inter']">
          Скоро появится
        </h2>
      </Card>
